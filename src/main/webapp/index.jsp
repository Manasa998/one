...
<body>
	...
	<h2 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENKINS</h2>
	<h3 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENKINS</h3>
